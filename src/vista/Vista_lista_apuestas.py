...
class Vista_lista_apuestas(QWidget):
    ...
    def aniadir_apuesta(self):
        ...
        if dialogo.resultado == 1:
            resultado = self.interfaz.aniadir_apuesta(str(dialogo.combobox_competidores.currentText()), float(dialogo.texto_valor.text()), str(dialogo.combobox_apostadores.currentText()))
            if resultado != "":
    ...
    def editar_apuesta(self, id_apuesta):
        ...
        dialogo.exec_()
        if dialogo.resultado == 1:
            resultado = self.interfaz.editar_apuesta(id_apuesta, str(dialogo.combobox_competidores.currentText()), float(dialogo.texto_valor.text()), str(dialogo.combobox_apostadores.currentText()))
            if resultado != "":
                self.error(resultado)
    ...
    def error(self, error):
        ...
        mensaje_error.setWindowTitle("Error al guardar carrera")
